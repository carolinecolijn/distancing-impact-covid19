...
```{r ppd-facets, fig.cap="Posterior protective checks of the case counts. First panel (red) represents the observed cases. Other panels represent individual draws from the posterior protective distribution (i.e., these include the observation component).", out.width="\\textwidth"}
