...
```{r states, fig.cap="Draws from the state joint posterior distribution. Vertical dashed line represents the last day of data.", out.width="\\textwidth"}
incl_fig("states")
```
...
```{r ppd-quant, fig.cap="Same as last figure but with 80\\% and 50\\% quantiles. Black line represents the median. Red line represents the data.", out.width="5in"}
